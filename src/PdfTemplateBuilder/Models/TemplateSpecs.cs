...
namespace PdfTemplateBuilder.Models
{
	...
	public readonly struct LengthSpec
	{
		...
		public static LengthSpec Auto() => new() { IsAuto = true, Value = 0f };
		public static LengthSpec FromValue(float value) => new() { IsAuto = false, Value = value };
	}
	...
	public sealed class TableSpec
	{
		...
		public List<TableColumnSpec> Columns { get; set; } = [];
	...
	public sealed class VisibilitySpec
	{
		...
		public static VisibilitySpec DefaultVisible() => new() { Render = null, Flag = AnnotationVisibility.Visible };
